      ...
      <div className="w-full max-w-3xl rounded-[28px] border border-border bg-surface p-6 shadow-[0_28px_52px_rgba(16,18,20,0.14)] md:p-8">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          >
            ...
            <h2 className="font-heading text-lg font-bold text-text">Aplicativo Android (APK)</h2>
            <p className="mt-1 text-sm text-text-muted">Baixar versão para celulares Android.</p>
          ...
          >
            ...
            <h2 className="font-heading text-lg font-bold text-text">Aplicativo Desktop (.exe)</h2>
            <p className="mt-1 text-sm text-text-muted">Baixar instalador para Windows.</p>
            <div className="mt-4 inline-flex items-center gap-2 rounded-full bg-accent px-4 py-2 text-sm font-medium text-surface">
              <Download size={16} />
              Baixar .exe
              <ExternalLink size={14} />
