        ...
        <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-2">
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div><label className="block text-sm text-text-muted mb-1">Endereço *</label>
          ...
          <div className="ui-table-wrap">
            ...
            {expandedSections.responsavel && (
              <div className="p-4 space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  <div><label className="block text-sm text-text-muted mb-1">Nome do Responsável</label>
                    <input value={form.nome_responsavel} onChange={(e) => setForm({ ...form, nome_responsavel: e.target.value })} className={inputClass} /></div>
                  <div><label className="block text-sm text-text-muted mb-1">CPF do Responsável</label>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div><label className="block text-sm text-text-muted mb-1">Nascimento Responsável</label>
                  ...
                  <div><label className="block text-sm text-text-muted mb-1">Telefone Responsável</label>
            ...
            {expandedSections.contrato && (
              <div className="p-4 space-y-3">
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div><label className="block text-sm text-text-muted mb-1">Início do Contrato</label>
          ...
          <div className="ui-table-wrap">
            ...
            {expandedSections.saude && (
              <div className="p-4 space-y-3">
                <div><label className="block text-sm text-text-muted mb-1">Restrições (alergias, necessidades especiais)</label>
                  <textarea value={form.restricoes} onChange={(e) => setForm({ ...form, restricoes: e.target.value })} rows={2} className={inputClass} /></div>
                <div><label className="block text-sm text-text-muted mb-1">Observações Gerais</label>
          ...
          <div className="ui-table-wrap">
            ...
            {expandedSections.biometria && (
              <div className="p-4 space-y-4">
                ...
                <button type="button" onClick={() => alert('Funcionalidade de captura facial será implementada em breve')}
