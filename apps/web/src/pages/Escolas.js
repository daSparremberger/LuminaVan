...
export function Escolas() {
    ...
    return (_jsxs("div", { children: [_jsx(PageHeader, { title: "Escolas", subtitle: `${escolas.length} escola(s) cadastrada(s)`, action: _jsxs("button", { onClick: openNew, className: "flex items-center gap-2 bg-accent hover:bg-accent/90 text-beige px-4 py-2 rounded-xl text-sm font-medium", children: [_jsx(Plus, { size: 18 }), " Nova Escola"] }) }), escolas.length === 0 ? (_jsx(EmptyState, { icon: School, message: "Nenhuma escola cadastrada" })) : (_jsx("div", { className: "border border-beige/10 rounded-xl overflow-hidden", children: _jsxs("table", { className: "w-full", children: [_jsx("thead", { className: "bg-beige/5 text-left text-sm text-beige/40", children: _jsxs("tr", { children: [_jsx("th", { className: "px-4 py-3", children: "Nome" }), _jsx("th", { className: "px-4 py-3", children: "Endereco" }), _jsx("th", { className: "px-4 py-3", children: "Turnos" }), _jsx("th", { className: "px-4 py-3", children: "Contatos" }), _jsx("th", { className: "px-4 py-3 w-24" })] }) }), _jsx("tbody", { className: "text-sm", children: escolas.map((e) => (_jsxs(Fragment, { children: [_jsxs("tr", { className: "border-t border-beige/10 hover:bg-beige/3", children: [_jsx("td", { className: "px-4 py-3 text-beige", children: e.nome }), _jsx("td", { className: "px-4 py-3 text-beige/40", children: e.endereco }), _jsx("td", { className: "px-4 py-3 text-beige/40", children: [e.turno_manha && 'M', e.turno_tarde && 'T', e.turno_noite && 'N'].filter(Boolean).join(', ') || '-' }), _jsx("td", { className: "px-4 py-3", children: _jsxs("button", { onClick: () => toggleContatos(e.id), className: "flex items-center gap-1 text-beige/40 hover:text-accent", children: [_jsx(Users, { size: 16 }), _jsx("span", { className: "text-xs", children: "Ver" })] }) }), _jsxs("td", { className: "px-4 py-3 flex gap-2", children: [_jsx("button", { onClick: () => openEdit(e), className: "text-beige/40 hover:text-beige", children: _jsx(Pencil, { size: 16 }) }), _jsx("button", { onClick: () => remove(e.id), className: "text-beige/40 hover:text-red-400", children: _jsx(Trash2, { size: 16 }) })] })] }), expandedSchool === e.id && (_jsx("tr", { className: "bg-beige/5/30", children: _jsx("td", { colSpan: 5, className: "px-4 py-3", children: schoolContatos.length === 0 ? (_jsx("p", { className: "text-beige/30 text-sm", children: "Nenhum contato cadastrado" })) : (_jsx("div", { className: "space-y-2", children: schoolContatos.map((c) => (_jsxs("div", { className: "flex items-center gap-4 text-sm", children: [_jsx("span", { className: "bg-accent/20 text-accent px-2 py-0.5 rounded text-xs font-medium", children: c.cargo }), _jsx("span", { className: "text-beige", children: c.nome }), c.telefone && _jsx("span", { className: "text-beige/40", children: c.telefone })] }, c.id))) })) }) }))] }, e.id))) })] }) })), _jsx(Modal, { open: modalOpen, onClose: () => setModalOpen(false), title: editing ? 'Editar Escola' : 'Nova Escola', children: _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm text-beige/40 mb-1", children: "Nome" }), _jsx("input", { value: form.nome, onChange: (e) => setForm({ ...form, nome: e.target.value }), className: "w-full bg-beige/5 border border-beige/10 rounded-xl px-4 py-3 text-beige text-sm focus:outline-none focus:border-accent" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm text-beige/40 mb-1", children: "Endereco" }), _jsx("input", { value: form.endereco, onChange: (e) => setForm({ ...form, endereco: e.target.value }), className: "w-full bg-beige/5 border border-beige/10 rounded-xl px-4 py-3 text-beige text-sm focus:outline-none focus:border-accent" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm text-beige/40 mb-2", children: "Turnos" }), _jsx("div", { className: "flex gap-4", children: ['manha', 'tarde', 'noite'].map((t) => (_jsxs("label", { className: "flex items-center gap-2 text-sm text-gray-300", children: [_jsx("input", { type: "checkbox", checked: form[`turno_${t}`], onChange: (e) => setForm({ ...form, [`turno_${t}`]: e.target.checked }), className: "rounded bg-beige/5 border-beige/10" }), t.charAt(0).toUpperCase() + t.slice(1)] }, t))) })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm text-beige/40 mb-2", children: "Contatos" }), _jsxs("div", { className: "space-y-2", children: [contatos.map((c, i) => (_jsxs("div", { className: "flex gap-2 items-center", children: [_jsx("select", { value: c.cargo, onChange: (e) => updateContato(i, 'cargo', e.target.value), className: "bg-beige/5 border border-beige/10 rounded-xl px-3 py-2 text-beige text-sm focus:outline-none focus:border-accent", children: CARGO_OPTIONS.map((cargo) => (_jsx("option", { value: cargo, children: cargo }, cargo))) }), _jsx("input", { placeholder: "Nome", value: c.nome, onChange: (e) => updateContato(i, 'nome', e.target.value), className: "flex-1 bg-beige/5 border border-beige/10 rounded-xl px-3 py-2 text-beige text-sm focus:outline-none focus:border-accent" }), _jsx("input", { placeholder: "Telefone", value: c.telefone, onChange: (e) => updateContato(i, 'telefone', e.target.value), className: "w-32 bg-beige/5 border border-beige/10 rounded-xl px-3 py-2 text-beige text-sm focus:outline-none focus:border-accent" }), _jsx("button", { onClick: () => removeContato(i), className: "text-beige/40 hover:text-red-400 p-1", type: "button", children: _jsx(X, { size: 18 }) })] }, i))), _jsxs("button", { onClick: addContato, type: "button", className: "flex items-center gap-1 text-accent hover:text-accent/80 text-sm font-medium", children: [_jsx(Plus, { size: 16 }), " Adicionar Contato"] })] })] }), _jsx("button", { onClick: save, className: "w-full bg-accent hover:bg-accent/90 text-beige font-semibold py-3 rounded-xl", children: editing ? 'Salvar' : 'Criar' })] }) })] }));
}
